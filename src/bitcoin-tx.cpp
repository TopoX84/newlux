...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lux-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lux-tx [options] <hex-tx> [commands]  Update hex-encoded lux transaction\n" +
            "or:     lux-tx [options] -create [commands]   Create hex-encoded lux transaction\n" +
            "\n";
