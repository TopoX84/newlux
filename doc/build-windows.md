...
It's not possible to build the LUXCORE code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the LUXCORE source code).
