Gitian building
================
*Setup instructions for a Gitian build of LUXCORE using a Debian VM or physical system.*
...
- [Building LUXCORE](#building-lux-core)
...
To build LUXCORE (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/LUX-Core/newlux
